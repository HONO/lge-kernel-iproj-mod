...
/* kwangdo.yi@lge.com [jointlab] Thu 14 Apr 2011 S
   added lge sensor feature to fix build error
*/
...
struct platform_device *msm_footswitch_devices[] = {
	...
	/* 11.03.16 jaeseong.gim@lge.com
		comment out for LCD suspend & resume */
#ifndef CONFIG_LGE_I_DISP_EARLYSUSPEND
	FS(FS_MDP,	"fs_mdp"),
#endif
	FS(FS_ROT,	"fs_rot"),
	FS(FS_VED,	"fs_ved"),
...
struct clk_lookup msm_clocks_8x60[] = {
...
#if defined(CONFIG_LGE_FUEL_GAUGE) || defined(CONFIG_LGE_SWITCHING_CHARGER_MAX8971) || defined(CONFIG_LGE_SWITCHING_CHARGER_BQ24160_DOCOMO_ONLY)
	CLK_8X60("gsbi_qup_clk",        GSBI5_QUP_CLK, "qup_i2c.11", OFF),
#else
	...
	CLK_8X60("gsbi_qup_clk",	GSBI10_QUP_CLK, "qup_i2c.9", OFF),
#else
...
#if defined(CONFIG_LGE_FUEL_GAUGE) || defined(CONFIG_LGE_SWITCHING_CHARGER_MAX8971) || defined(CONFIG_LGE_SWITCHING_CHARGER_BQ24160_DOCOMO_ONLY)
	CLK_8X60("gsbi_pclk",           GSBI5_P_CLK, "qup_i2c.11", OFF),
#else
...
#ifdef CONFIG_LGE_SENSOR
	CLK_8X60("gsbi_pclk",		GSBI10_P_CLK, "qup_i2c.9", OFF),
#else
	...
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_mt9m114.0", OFF),  //jisun.shin@lge.com
#else
...
#ifdef CONFIG_LGE_CAMERA
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_mt9m114.0", OFF),  //jisun.shin@lge.com
#else
...
#ifdef CONFIG_LGE_CAMERA
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_mt9m114.0", OFF),  //jisun.shin@lge.com
#else
