...
void lm3559_enable_torch_mode(int state)
{
    ...
    if(state == LM3559_LED_LOW){
		lm3559_write_reg(lm3559_i2c_client,LM3559_REG_TORCH_BRIGHTNESS,0x1B); // 011 : 112.5mA    
	}
	else{
		/* 111 111 : 225 mA  */ 
...
void lm3559_enable_flash_mode(int state)
{
	...
	/*0011 0011 : 225 mA => 0110 0110 : 393.75 mA _jonghwan.ko@lge.com_  */
		CDBG("[LM3559_LED_HIGH]LM3559_REG_FLASH_BRIGHTNESS \n");
		lm3559_write_reg(lm3559_i2c_client,LM3559_REG_FLASH_BRIGHTNESS,0x66); // 0110 : 393.75 mA
	}
